...
public class OrderTrackingTransformer {
    ...
    public TrackOrder transformToTrackOrderInternal(Order order) throws IOException {
    ...
    public TrackOrder transformToTrackOrderExternal(Order order) throws IOException {
